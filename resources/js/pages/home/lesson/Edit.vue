            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header pb-0">
                        ...
                        <p class="mb-0 text-sm">Update lesson data</p>
                    </div>
                    <div class="card-body">
                        <div class="row" v-if="this.data">
                            ...
                            <div class="col-12">
                                <argon-button color="secondary" variant="gradient" full-width class="my-2 py-4 btn-lg fs-6"
                                    @click="this.addSetCard">Add Card
                                </argon-button>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-sm-5">
                                <argon-button color="success" variant="gradient" full-width class="my-2 btn-lg fs-6"
                                    @click="this.updateLesson">Update
                                </argon-button>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    beforeMount() {
        this.$store.dispatch('lesson/getLessonInfoToEdit', this.lesson_id).then((res) => {
            this.data = res;
