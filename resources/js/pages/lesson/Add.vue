...
export default {
    ...
    created() {
        this.unsubscribe = this.$store.subscribe((mutation) => {
            ...
            } else if (mutation.type === 'lessonService/failure') {
    ...
    methods: {
        ...
        import() {
            ...
            if (this.importFile) {
                ...
                this.$store.dispatch('lessonService/importFile', formData);
            } else {
                this.$root.showSnackbar('Importing lesson...', 'info');
                try {
        ...
        addLesson() {
            this.type = 'add';
            this.$store.dispatch('lessonService/addLesson', {
