                ...
                <div id="basic-info" class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-sm btn-outline-primary" @click="lesson_modal.show()">
                                    Add Lesson
                                </button>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <select id="lesson" name="lesson" class="form-control" multiple>
                            </select>
                        </div>
                    </div>
                </div>
...
export default {
                ...
                if (this.type === 'get') {
                    ...
                    lessons.forEach((lesson) => {
                        this.lesson_datatable.rows.add([
                            ...
                            lesson.status,
                            `<a href="/user/lesson/${lesson.id}/edit" class="btn btn-sm btn-outline-primary">Edit</a>`
                        ]);
    ...
    methods: {
        init() {
            ...
            this.lesson_choice.passedElement.element.addEventListener('search', (event) => {
                ...
                this.timer = setTimeout(() => {
                    this.$store.dispatch('course/searchLesson', event.detail.value);
                }, 500);
            });
        ...
        addLesson() {
            ...
            this.$store.dispatch('course/addLessonToCourse', {
                id: this.$route.params.id,
        ...
        removeLesson() {
            if (confirm('Are you sure?')) {
                ...
                this.$store.dispatch('course/removeLessonFromCourse', {
                    id: this.$route.params.id,
